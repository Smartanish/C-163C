...
def openFile():
    ...
    text_file=feildialog.askopenfilename(title="Open Text File", filetypes=(("text Files", "*.txt"),))
    print(text_file)
...
exit_button.place(relx=0.05,rely=0.03,anchor=CENTER)
root.mainloop()